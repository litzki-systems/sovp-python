...
# (draft-litzki-sovp, Section 4 MUST). sign_identity() will strip it automatically if present.
metadata = {
...
| IETF Internet-Draft | [draft-litzki-sovp](https://datatracker.ietf.org/doc/draft-litzki-sovp/) — active (updated 2026-06-09) |
